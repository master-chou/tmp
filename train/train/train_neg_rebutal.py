...
class DepthSpatialDataset(Dataset):
    def __init__(self, root_dir='', transform=None, depth_transform=None):
        ...
        json_file_path='/dataset/data/alldata_final.json'
        neg_file_path='/dataset/data/alldata_negative2case.json'
    ...
    def __getitem__(self, idx):
        ...
        depth_path = f'/dataset/data/full-depth-image/{record["image_id"]}'
